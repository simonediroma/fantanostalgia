...
**Branch attivo:** `claude/prossimo-task-h8zea3`
**PR in corso:** nessuna — branch pushato, PR non ancora aperta (task 28 completato, in attesa di richiesta esplicita). Nota: task 25 (PR #80), task 26 (PR #81) e task 27 (PR #82) sono stati mergiati da Simone direttamente (confermato a inizio di questa sessione con "ho già mergiato tutto").
