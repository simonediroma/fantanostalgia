...
**Branch attivo:** nessuno (prossimo: `task/00-seed-poc`)
**PR in corso:** nessuna
...
1. Crea branch `task/00-seed-poc` da `main`
2. Implementa task 00 seguendo `prompts/00-seed-poc.md`
3. Apri PR `task/00-seed-poc` → `main`
