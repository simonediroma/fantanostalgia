...
**PR in corso:** nessuna. Task 25 (PR #80), 26 (PR #81), 27 (PR #82), 28 (PR #83) e i follow-up di allineamento ai prompt aggiunti a posteriori per 25 (PR #84), 26 (PR #85), 27 (PR #86) e 28 (PR #87) sono tutti mergiati in `main`. I prompt per **29** e **31** sono stati aggiunti a posteriori (commit diretti su `main`) e ora esistono davvero in `prompts/frontend/`.
...
- [ ] **31** — Pagina pubblica "Come Funziona" standalone → `prompts/frontend/31-pagina-come-funziona.md` (esiste, aggiunto a posteriori) (branch: `task/31-pagina-come-funziona`, dipende da 25)
