...
- [ ] **29** — Gestione multi-lega in Admin → `prompts/frontend/29-multi-lega-admin.md` (esiste, aggiunto a posteriori) (branch: `task/29-multi-lega-admin`, dipende da 26)
